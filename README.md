...
If you're already logged into a different profile, `avsh` will remove the environment variables for the old profile and
log you into the new profile you've specified.
